...
const Footer = () => {
  ...
  return ReactDOM.createPortal(
    <>
      <footer
        ref={footerRef}
        className="fixed flex-wrap z-[3] lg:max-w-[90%] max-w-[52%] w-[90%] left-1/2 -translate-x-1/2 flex lg:flex-row flex-col gap-5 items-center lg:items-end lg:justify-between bottom-10"
      >
        <h2
          ref={titleRef}
          onClick={() => prev()}
        ...
        <div
          onClick={() => next()}
          className="flex flex-wrap lg:justify-start justify-center   next_text gap-3 mb-0 lg:mb-[10px] items-center pointer-events-auto"
        >
          <h2
            className="uppercase cursor-pointer font-[300] lg:tracking-[normal] tracking-[1.4] nextcontent text-center parallax next_title text-[18px] tracking-[2px]"
            ref={ctaRef}
          >
            {cta}
          </h2>
