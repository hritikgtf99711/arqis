...
const sectionConfigs = {
  platter: {
    ...
    table: {
      head: ["Name", "Short Description", "Image", "Alt Tag"],
  ...
  timeline: {
    ...
    table: {
      head: ["Year", "Short Description", "Image", "Alt Tag"],
      header: ["year", "short_description", "image", "alt"],
    },
    endpoint: "timeline",
    label: "Timeline",
  },
  "amenities-logo": {
    ...
    table: {
      head: ["Name", "Alt Tag", "Image"],
      header: ["name", "alt", "logoUrl"],
    },
  ...
  award: {
    ...
    table: {
      ...
      header: ["title", "description", "year", "file", "alt_txt"],
    },
    endpoint: "award",
    label: "Awards",
  },
  news: {
    ...
    table: {
      head: ["Short Description", "Logo", "Image", "Alt Tag", "Date"],
      header: ["short_description", "logo", "image", "alt", "date_at"],
    },
    endpoint: "news",
    label: "News",
  },
  ...
  "our-story": {
    ...
    table: {
      head: ["Image", "Alt Tag", "Type", "Sequence"],
      header: ["image", "alt_text", "type", "sequence"],
    },
  ...
  "our-team": {
    fields: [
      ...
      { type: "image", name: "signature", label: "signature" },
      { type: "text", name: "alt", label: "Alt Tag" },
      { type: "text", name: "seq", label: "SEQ" },
  ...
  jobs: {
    ...
    table: {
      head: ["Job Title", "Location", "Education", "Experience"],
      header: [
        "job_title",
        "location",
        "education_required",
  ...
  "press-kit": {
    ...
    table: {
      head: ["Title", "Image", "Alt"],
      header: ["title", "image", "alt_text"],
    },
    endpoint: "presskit",
    label: "Press Kit",
  },
  "press-kit-logos": {
    ...
    table: {
      head: ["Label", "Image", "Alt"],
      header: ["label", "image", "alt"],
    },
    endpoint: "logos",
    label: "Press Kit",
  },
...
const CmsSections = () => {
  ...
  const { tableData: MetaFields } =
    slug === "our-team" ? useCrud(api, "team/categories") : { tableData: [] };
  const { tableData: pressKit } =
    slug === "press-kit-logos" ? useCrud(api, "presskit") : { tableData: [] };
