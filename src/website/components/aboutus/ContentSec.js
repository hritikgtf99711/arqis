...
export default function ContentSec({overviewData}) {
  ...
  return (
    <div className='fade-up mr-auto h-[100%]  max-w-[100%] 2xl:max-w-[calc(76%+6px)] flex flex-col justify-start'>
      <CommonHeading customClass={'pb-[20px] 2xl:pb-[40px] text-[#113120]'} heading={overviewData?.title}/>
