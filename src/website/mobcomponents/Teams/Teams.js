...
import TeamCard from '@/website/components/Team/TeamCard';
...
export default function App() {
  ...
  const progressBarRef = useRef(null); // Reference to progress bar element
  const cursorRef = useRef(null); // Reference to custom cursor image
  const dragIconRef = useRef(null); // Reference to default drag icon
